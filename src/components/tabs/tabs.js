...
export default function BasicTabs() {
  ...
  const allProducts = [
    ...
    },
    {
      ...
      additionalSpecs: {
        AnchoEfectivo: "106.7 cms | 42\" in",
        calibres: "26/26",
        largos: "Mínimo: 2.50 mts | 98.42\" in <br> Máximo: 12.40 mts | 480.31\" in",
        espesor: "1\" | 1.5\" | 2\" | 2.5\" | 3\" | 4\" | 5\" | 6\"",
        tipoDeEspuma: "<strong>PUR |</strong> Poliuretano <br> <strong>PIR |</strong> Poliisoocianurato",
        recomendaciones: "Pijas autoroscantes de 1/4” x largo = al espesor de panel + 1”."
      },
    ...
    },
    {
      ...
      additionalSpecs: {
        AnchoEfectivo: "1.00 mts | 39.37\" in",
        calibres: "26/Vinil",
        largos: "<strong>Mínimo:</strong> 2.50 mts | 98.42\" in <br> <strong>Máximo:</strong> 12.00 mts | 39.37\" in",
        espesor: "1\" | 1.5\" | 2\"",
        tipoDeEspuma: "<strong>PUR |</strong> Poliuretano <br> <strong>PIR |</strong> Poliisoocianurato",
        recomendaciones: "Pijas autoroscantes de 1/4” x largo = al espesor de panel + 1”."
      },
    ...
    },
    {
      ...
      specs: "Es un panel TIPO SAND hermético compuesto por 1 lámina de acero GR-37 con un centro de poliuretano y una CARA INTERNA de vinil, diseñado para interiores, con una estética metálica industrial. <br><br>Se utilizan para levantar muros y aislar un espacio acústico y térmicamente del paso de caloro frío con fines de eficiencia energética y auditiva. <br><br></br>Es la opción perfecta para tus proyectos de construcción en muros al interior de naves industriales, comerciales, almacenes, laboratorios, y cámaras de refrigeración, entre otros espacios, su sistema de acoplamiento evita el riesgo de filtración de elementos exteriores.",
      additionalSpecs: {
        AnchoEfectivo: "106.7 cms | 42\" in",
        calibres: "26 / Vinil",
    ...
    },
    {
      ...
      additionalSpecs: {
        AnchoEfectivo: "1.00 mts | 39.37\" in",
        calibres: "24/24 | 24/26 | 26/26 | 26/28",
        largos: "Mínimo: 2.50 mts | 98.42\" in <br> Máximo: 16.000 mts | 52'-6\" in",
        espesor: "1.5\" | 2\"",
        tipoDeEspuma: "PUR | Poliuretano<br>PIR | Poliisoocianurato",
        recomendaciones: "Pijas autoroscantes de 1/4” x largo = al espesor de panel + 1”."
      },
